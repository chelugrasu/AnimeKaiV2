<template>
  ...
  <div class="Genres">
      <p class="Genre" style="padding-top: 103vh;">Acțiune</p>
      ...
      <p class="Genre" style="padding-top: 3vh;">Aventură</p>
      ...
      <p class="Genre" style="padding-top: 3vh;">Dramă</p>
      <div class="swiper-container" id="swiper-container" style="padding-top: 10vh;">
        <div class="swiper-wrapper swiper-wrapperSmall">
      ...
      <p class="Genre" style="padding-top: 3vh;">Fantezie</p>
      <div class="swiper-container" id="swiper-container" style="padding-top: 10vh;">
        <div class="swiper-wrapper swiper-wrapperSmall">
      ...
      <p class="Genre" style="padding-top: 3vh;">Comedie</p>
      <div class="swiper-container" id="swiper-container" style="padding-top: 10vh;">
        <div class="swiper-wrapper swiper-wrapperSmall">
      ...
      <p class="Genre" style="padding-top: 3vh;">Sci-Fi</p>
      <div class="swiper-container" id="swiper-container" style="padding-top: 10vh;">
        <div class="swiper-wrapper swiper-wrapperSmall">
    ...
    async loadHomePage(){
      const response = await fetch(`${process.env.VUE_APP_API_BASE_URL}/api/loadHomePage`, {
        ...
        if (response.ok) {
          ...
          this.actionSeries = await this.getRandomSeries(data.series, 'Action');
          this.adventureSeries = await this.getRandomSeries(data.series, 'Adventure');
          this.dramaSeries = await this.getRandomSeries(data.series, 'Drama');
          this.fantasySeries = await this.getRandomSeries(data.series, 'Fantasy');
          this.comedySeries = await this.getRandomSeries(data.series, 'Comedy');
