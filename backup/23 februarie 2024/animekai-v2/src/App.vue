<template>
  <div id="app">
    ...
    <div class="logo"></div>
    <div class='headerButton' id="homeButton"><font-awesome-icon class="headerButtonIcon" style="color: white;" :icon="['fas', 'house']" /><p>Acasă</p></div>
    <div class='headerButton' style="left: 34vh; top: 0vh;" id="seriesButton"><font-awesome-icon class="headerButtonIcon" style="color: white;" :icon="['fas', 'desktop']" /><p>Seriale</p></div>
    <div class='headerButton' style="left: 45vh;" id="moviesButton"><font-awesome-icon class="headerButtonIcon" style="color: white;" :icon="['fas', 'film']" /><p>Filme</p></div>
